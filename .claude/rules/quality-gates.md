...
| Major | Incorrect variable deflation | -10 |
...
|----------|-----------|-----------|
| Point estimates (β, ρ, σ) | < 1e-6 | Numerical precision of optimization |
| Standard errors | < 1e-4 | Wild bootstrap MC variability (B=50) |
| Significance stars | Exact match | Discrete classification must agree |
| Inefficiency estimates | < 1e-5 | JLMS computation through spatial filter |
